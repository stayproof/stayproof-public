...
you have an algorithm suggestion, please open an issue at
...
- **Extension bugs, feature requests, UX feedback:** open an issue at
  [stayproof/stayproof-feedback](https://github.com/stayproof/stayproof-feedback).
  This is the canonical feedback channel for users.
- **Code-level bugs in the files published here** (e.g., "the Booking
  scraper regex misses prices with non-breaking spaces"): issues on
  THIS repo are fine.
